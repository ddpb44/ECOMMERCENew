...
<body>
	...
	<input class="formprod" id="myInputPro" type="text"
		placeholder="Rechercher">
	<button type="button" data-toggle="modal" data-target="#AjoutPro"
		style="position: absolute; width: 15%; right: 20%; top: 10%"
		class="btn btn-primary">AJOUTER UN PRODUIT</button>

	<div class="tablePro" align="center"
		style="position: absolute; top: 15%">
		<table class="table table-hover ">
			<thead>
				<tr class="header">
	...
	<div id="AjoutPro" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<f:form class="form-horizontal" method="POST"
						modelAttribute="proAddForm" action="${pageContext.request.contextPath}/produit/insererProduit"
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="pro_quantite">Prix:</label>
							<div class="col-sm-10">
